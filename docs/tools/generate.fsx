...
let website = "/FSharpPerf"

let githubLink = "https://github.com/fsprojects/FSharpPerf"

// Specify more information about your project
let info =
  [ "project-name", "FSharpPerf"
    "project-author", "Steffen Forkmann"
    "project-summary", "A set of performance test scripts for the F# compiler."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FSharpPerf" ]
